...
- `generate-manifests.sh`: Shell script automation for generating rendered manifests and consolidated bootstrap files. Driven entirely by the GitHub Actions pipeline upon commit. Manual generation locally is obsolete (see `agents.md` Rule #2).